...
class All_Posts extends Component {
    ...
    componentDidMount(){
        ...
        axios.get('http://127.0.0.1:8000/api/v0/posts/main-categories')
            .then(res => {
    ...
    onClickLikeButton = (postID) => {
        ...
        .then(res => {
            ...
            if (this.props.user.authUser.user_id === this_post_liked_user.find(res => res === this.props.user.authUser.user_id)) {
                var index = this_post_liked_user.indexOf(this.props.user.authUser.user_id);
                if (index !== -1)
                ...
                this_post_liked_user.push(this.props.user.authUser.user_id);
                axios(`http://127.0.0.1:8000/api/v0/posts/post-with-filtered/${postID}`, {
                    auth: { username: this.props.user.authUser.username, password: localStorage.getItem('user_password') },
                    credentials: 'include',
                    method: 'PATCH',
    ...
    render() {
        const { isPageReady, posts, categories } = this.state;
                    ...
                    <>
                        ...
                        <Navbar isPageReady={isPageReady}/>
                            <div className="allPostPage__cover">
                                <LeftSideMenu theme={this.props.theme} isPageReady={isPageReady} user={this.props.user}/>
                                                                        ...
                                                                        <SwiperSlide key={post.id} className="swiper-slide post_card animate__animated animate__flipInX">
                                                                            ...
                                                                            <div className="card-interactive">
                                                                                ...
                                                                                {(() => {
                                                                                            ...
                                                                                            if (post.likes.find(user_id => user_id === this.props.user.authUser.user_id)) {
                                                                                                return (
                                                                                                    <div className="up if_post_liked" onClick={()=>this.onClickLikeButton(post.id,this)}>
                                                                                                        <img alt="" src={this.props.theme.dark ?  dark_up_vote_icon : light_up_vote_icon} />
                                                                                                        <span 
                                                                                                ...
                                                                                                return(
                                                                                                    <div className="up" onClick={()=>this.onClickLikeButton(post.id,this)}>
                                                                                                        <img alt="" src={this.props.theme.dark ?  dark_up_unvote_icon : light_up_unvote_icon} />
                                                                                ...
                                                                                <div className="comment">
                                                                                    <img alt=""
                                                                                        src={this.props.theme.dark ? "https://img.icons8.com/fluency-systems-filled/20/A8B3CF/comments--v2.png" : "https://img.icons8.com/fluency-systems-filled/20/233B55/comments--v2.png"}/>
                                                                                    <span>5</span>
                                                                                </div>
                                                                                <div className="bookmark">
                                                                                    <img alt=""
                                                                                        src={this.props.theme.dark ? "https://img.icons8.com/fluency-systems-filled/21/A8B3CF/bookmark-ribbon.png" : "https://img.icons8.com/fluency-systems-filled/21/233B55/bookmark-ribbon.png"} />
                                                                                </div>
                                                                            </div>
                                                                        </SwiperSlide>
                                                                    )
...
export default connect(mapStateToProps,mapDispatchToProps)(All_Posts)
